...
(0..rango).each { i ->
    ...
    //FECHA DE APLICACION
    //LA FECHA LA OBTIENE DE LA CAPTURA DE LA PANTALLA, SOLO APLICA FORMATO
    ...
    vlIdMovimiento = PKG_PROCESADOR_FINANCIERO.pProcesaMovimiento(sCveGpoEmpresa, sCveEmpresa, sIdPreMovi, 'PV',sCveUsuario,
								 'F', pTxrespuesta, sql);
